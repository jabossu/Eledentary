...
'page_config'	=>	"Parameters",
'websiteTitle'	=>	"Website title",
'websiteMoto'	=>	"Website moto",
'websiteFooter'	=>	"Website footer",
'websiteLanguage'	=>	"Default language",
'allowRegister'	=>	"Allow user registration",
'bypassApproval'	=>	"Bypass users approval",
'allowAnamneses'	=>	"Allow anamneses",
'patientLimit'	=>	"Max number of patients per student",
