...
//Userbar
'hello_message'		=>			"Bonjour %PRENOM NOM%",
...
'page_listepatho'	=>			"Liste des pathologies",
'nom_patho'			=>			"Pathologie",
'patho_details'		=>			"Détails",

// > Mes Patients
'patho_nom'				=>			"Pathologie",
'free_patient_ok'		=>			"Libération du patient réussi",
'reserve_patient_ok'	=>			"Réservation de patient réussi",
'delete_patient_ok'		=>			"Supression du patient réussi",
'patient_hasmedic'		=>			"Le patient est deja réservé",
...
// Réservation Patient
'action_free'		=>			"Libérer le patient",
'my_patient'		=>			"Mes Patients",
'action_reserve'	=>			"Réserver le Patient",
...
// Config Page
'page_config'		=>	"Parametres",
'websiteTitle'		=>	"Titre du site",
'websiteMoto'		=>	"Slogan du site",
'websiteFooter'		=>	"Pied de page",
'websiteLanguage'	=>	"Langue par defaut",
'allowRegister'		=>	"Autoriser les inscription des utilisateurs",
'bypassApproval'	=>	"Desactiver la verification des utilisateurs",
'allowAnamneses'	=>	"Activer les anamneses",
'patientLimit'		=>	'Nombre maximum de patients par eleves',
