...
// > Profile de patient
'page_profile_patients'	=>			"Profilul de pacienți",
'info_patient'		=>			"Informaţii generale",
'info_pathologie'	=>			"Informații despre boala",
'cnp'				=>			"C.N.P",
'dent'				=>			"Dent atteinte",
'info_contact'		=>			"Mijloace de contact",
'update_patient_ok'	=>			"Modifications enregistrées",
'register_patient_ok'	=>		"pacient înregistrat",
'bad_form_patient'	=>			"Formulaire incorrecte : veuillez réessayer",
'bad_infos_patient'	=>			"Completați toate câmpurile",
'register'			=>			"înregistra",
...
// Réservation Patient
'action_free'		=>			"Deblocarea pacientului",
'my_patient'		=>			"Pacientii mei",
'action_reserve'	=>			"Rezervați direct pacientului",
